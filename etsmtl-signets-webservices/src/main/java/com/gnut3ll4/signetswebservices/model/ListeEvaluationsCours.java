...
public class ListeEvaluationsCours extends DonneesRetournees implements KvmSerializable
{
    ...
    public ListeEvaluationsCours(java.lang.Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("listeEvaluations"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.listeEvaluations = new ArrayOfEvaluationCours(j,__envelope);
                    }
                    continue;
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            return this.listeEvaluations!=null?this.listeEvaluations:SoapPrimitive.NullSkip;
        }
