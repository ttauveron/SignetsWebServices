...
public class ListeDeSessions extends DonneesRetournees implements KvmSerializable
{
    ...
    public ArrayOfTrimestre liste;

    public ListeDeSessions()
    {
    }

    public ListeDeSessions(java.lang.Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("liste"))
                {
                    if(obj!=null)
                    {
                        ...
                        this.liste = new ArrayOfTrimestre(j,__envelope);
                    }
                    continue;
                }
