...
public class ListeDeCours extends DonneesRetournees implements KvmSerializable
{
    ...
    public ArrayOfCours liste;

    public ListeDeCours()
    {
    }

    public ListeDeCours(java.lang.Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("liste"))
                {
                    if(obj!=null)
                    {
                        ...
                        this.liste = new ArrayOfCours(j,__envelope);
                    }
                    continue;
                }
